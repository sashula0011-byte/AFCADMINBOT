...
async def cmd_broadcast(message: types.Message):
    ...
    await message.reply("📣 Выбери филиал для рассылки:", reply_markup=kb_branch_picker("bc_branch", "bc_cancel"))
...
# ==========================
# Any message: save chat + send broadcast
# ==========================
